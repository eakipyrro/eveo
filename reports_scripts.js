...
(() => {
    ...
    async function calculateReportAjax(e) {
        ...
        try {
            ...
            if (total === 0) {
                alert('Ei spotteja valitulla aikaväillä');
                return;
            }
    ...
    (() => {
        ...
        const exportBtn = document.getElementById('btnExportDebug');
        ...
        function exportToCSV() {
            ...
            table.querySelectorAll('tbody tr').forEach(tr => {
                ...
                tr.querySelectorAll('td').forEach(td => {
                    ...
                    // If text contains semicolon or quotes, wrap in quotes and escape quotes
            ...
            link.setAttribute('download', 'debug_report_' + timestamp + '.csv');
