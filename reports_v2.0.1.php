...
// Kirjaa aina sivulle tulo (GET), jotta admin nökee käytön
...
";
    ...
    try {
        ...
        // päälaskenta, mikÃ¤ aiheutti eron. Nyt käytetään aina päälaskentaa.
...
<?php if ($isRun && !$rangeError): ?>
    ...
    <form method="get" action="">
        ...
        <div class="report-summary" style="max-width:1100px;margin-top:18px;">
            ...
            <!-- Leveä taulukko: näkyy desktopilla / isolla nytöllä, ja mobiilissa sivuttaisvieritys toimii -->
            <div class="h-scroll">
