            ...
            <div class="h-scroll">
                <table class="table table-bordered" style="width:100%; border-collapse:collapse;">
                    <tbody>
                        ...
                        <?php if ($debugOn): ?>
                        <tr>
                            <td colspan="4" style="background: #e3f2fd; padding: 10px; font-size: 12px;">
                                <strong>DEBUG INFO:</strong><br>
                                - useSessionData: <?= $useSessionData ? 'YES' : 'NO' ?><br>
                                - durationStats count: <?= count($durationStats) ?><br>
                                - durationStats empty: <?= empty($durationStats) ? 'YES' : 'NO' ?><br>
                                - Keys: <?= empty($durationStats) ? 'none' : implode(', ', array_keys($durationStats)) ?>
                            </td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                        ...
                        <?php if (!empty($durationStats)): ?>
                            <!-- DEBUG: Show raw durationStats -->
                            <?php if ($debugOn): ?>
                                <tr>
                                    <td colspan="4" style="background: #ffffcc; padding: 10px; font-family: monospace; font-size: 11px;">
                                        <strong>DEBUG - Raw durationStats:</strong><br>
                                        <?= htmlspecialchars(print_r($durationStats, true)) ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            <tr>
