...
$trp3564_pct_3p = ($populationN > 0)
    ? round((($trpFactor * (float) $reach3pSum) / $populationN), 2)
    : 0.00;
$trp3564_pct_avg = ($populationN > 0)
    ? round((($trpFactor * (float) $avgViewersSum) / $populationN), 2)
    : 0.00;
                ...
                <table class="table table-bordered" style="width:100%; border-collapse:collapse;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= number_format((int) $reach3pSum, 0, ',', ' ') ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            <td><strong>avg_viewers (summa)</strong></td>
                        ...
                        <tr>
                            ...
                            <td><?= number_format($trp3564_pct_3p, 2, ',', ' ') ?> </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            <td><strong>TRP (35–64), avg_viewers</strong></td>
            ...
            <div class="report-cards">
                ...
                <div class="report-card">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="label">avg_viewers (summa)</div>
