...
$minISO = $maxISO = null;
$minDisp = $maxDisp = 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â';
...
if ($isRun && $debugOn && !$rangeError && $campaign !== '' && $effFrom && $effTo) {
    ...
    // 2) Varsinainen debug-listaus - OPTIMOITU versio JOINilla
    // Duration parsing for debug
    $durSec = "
        CASE
          WHEN o.`duration` REGEXP '^[0-9]+$'
            THEN CAST(o.`duration` AS UNSIGNED)
    ...
    joined AS (
        SELECT
            x.oatv_id,
            DATE_FORMAT(x.spot_dt, '%Y-%m-%d %H:%i:%s') AS spot_datetime,
            x.dur_sec,
            (
...
";
    ...
    try {
        ...
        // Aiemmin tässä laskettiin $avgViewersSumFromDebug ja ylikirjoitettiin
        // päälaskenta, mikä aiheutti eron. Nyt käytetään aina päälaskentaa.
...
$spotLengthDisplay = 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â';
...
// --- Käyttäjän muokattavat kentät (säilyvät GET:ssÃƒÆ’Ã‚Â¤) ---
...
<?php if ($debugOn): ?>
    <div style="margin:8px 0;color:var(--muted);">
        OATV sisään: <?= (int) $dbg_oatv_in ?> riviä JOIN-osumia: <?= (int) $dbg_join_hit ?> riviä    </div>
    ...
    <?php if ($isRun && !$rangeError && $campaign !== '' && array_sum($diagCounts) === 0): {
        ...
        <div class="error-box">
            ...
            (LIKE on jo käytössä) tai varmista, käytetäänö OATV:ssä eri nimeä.
        </div>
    <?php endif; ?>
...
<?php if ($isRun && !$rangeError): ?>
    ...
    <form method="get" action="">
        ...
        <div class="report-summary" style="max-width:1100px;margin-top:18px;">
            ...
            <!-- Mobiilikortit: nääkyy vain alle 640px -->
            <div class="report-cards">
                ...
                <div class="report-card">
                    ...
                    <div class="row">
                        <!--                        <div class="label">Tavoitettu yleisÃƒÆ’Ã‚Â¶ (3+)</div>
        ...
        <!-- <div class="controls" style="justify-content:flex-end;max-width:1100px;">
            <button type="submit" class="primary">PÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ivitÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ kentÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤t</button>
        </div> -->
    </form>

    <?php
    // --- OATV peek (admin debug) ---
// NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤yttÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ 20 viimeisintÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ OATV-riviÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ valitulta aikavÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤liltÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤,
// jotta nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤et millÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ nimillÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤ kampanja oikeasti esiintyy.
    $peekRows = [];
            ...
            <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="dbgTitle">
                <div class="modal-header">
                    ...
                    <div style="display:flex;gap:10px;">
                        <button type="button" class="btn" id="btnExportDebug" aria-label="Vie CSV">Vie CSV</button>
                        <button type="button" class="modal-close" id="btnCloseDebug" aria-label="Sulje">&times;</button>
                    </div>
                </div>
                <div class="modal-body">
                    ...
                    <?php else: ?>
                        <div class="h-scroll">
                            <table id="debugTable" style="width:100%;border-collapse:collapse;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:left;padding:6px 8px;">Spot length</th>
                                        <th style="text-align:right;padding:6px 8px;">3+ viewers</th>
                                        <th style="text-align:right;padding:6px 8px;">Avg viewers</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($debugRows as $d): ?>
                                        <tr>
                                            ...
                                            <td style="padding:6px 8px;"><?= $d['dur_sec'] ? h(sec_to_hhmmss((int)$d['dur_sec'])) : '-' ?></td>
                        ...
                        <p style="margin-top:8px;color:var(--muted);">
                            Näytetään enintään 2000 riviä. Suodata tarkemmin, jos tarvitset täydellisen listan.
                        </p>
                    <?php endif; ?>
                </div>
            </div>
