...
if ($isRun && !$rangeError && $campaign !== '' && $effFrom && $effTo) {
    ...
    SELECT
        ...
        -- Tavoitettu yleisÃ¶ (3+): haetaan edellinen ohjelma
        (
            ...
            WHERE
                ...
                -- edellinen tai kÃ¤ynnissÃ¤ oleva ohjelma:
                AND $or_start <= x.spot_dt
                -- rajataan tarvittaessa myÃ¶s pÃ¤ivÃ¤mÃ¤Ã¤rÃ¤vÃ¤liin
                AND DATE($or_start) BETWEEN :dfrom AND :dto
            ORDER BY $or_start DESC
            LIMIT 1
        ) AS over60_on_channel,

        -- KeskimÃ¤Ã¤rÃ¤iset katsojat: sama logiikka
        (
    ...
    SELECT
        ...
        /* avg_viewers summataan myÃ¶s â€“ toleroidaan merkkijonoarvot CASTilla */
        SUM(
            CASE
